...
const FaqQuestions = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-20 mt-11">
      <div className="max-w-3xl mx-auto text-center mb-10">
        <small className="text-sm text-orange-400 uppercase mb-2">
          Your Questions, Our Clarity
        </small>
        <h2 className="text-5xl md:text-4xl font-semibold text-gray-800">
          ...
          <div key={index} className="relative md:flex md:items-start">
            <button
              ...
              className={`
                ...
                font-medium text-gray-700 border border-gray-200 hover:bg-blue-50 hover:border-blue-500 flex hover:bg-blue-500 hover:text-white
                ${
                  activeIndex === index
