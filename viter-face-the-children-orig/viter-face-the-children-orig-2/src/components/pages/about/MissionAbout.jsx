  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between px-6 py-20 max-w-7xl mx-auto gap-11">
      <div className="w-full md:w-1/2 flex justify-center mb-10 md:mb-0">
        <img src="./img/About/about-mission.webp" alt="about mission" />
      </div>

      <div className="max-w-xl md:ml-12 md:w-1/2">
        <h4 className="text-orange-400 text-sm font-medium uppercase">
          Mission
        </h4>
        <div>
          <div className="max-w-xl">
            <h2 className="text-3xl font-bold text-blue-400 font-semibold mt-2 mb-4">
