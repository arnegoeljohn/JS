    ...
    <div className="bg-white py-10">
      <div className="max-w-7xl mx-auto px-4 lg:flex justify-between items-start gap-10">
        ...
        <div className="lg:w-1/2">
          <small className="text-sm text-orange-500 uppercase">Let's Talk</small>
          ...
          <p className="mb-2">
            <strong className="text-blue-400">Philippines:</strong>{" "}
            <a href="tel:+639274203409" className="text-blue-400">
              +63 927 420 3409
            </a>
          </p>
          <p className="mb-4">
            <strong className="text-blue-400">USA:</strong>{" "}
            <a href="tel:+18157979177" className="text-blue-400">
              +815 797 9177
            </a>
          </p>
          <p>
            ...
            >
              Frontline Mission Center, Sitio Subac, <br /> Brgy. Sto Niño, San Pablo City, 4000 Laguna
            </a>
          </p>
        </div>
